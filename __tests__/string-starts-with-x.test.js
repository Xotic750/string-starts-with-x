import $startsWith, {implementation} from '../src/string-starts-with-x';

[implementation, $startsWith].forEach((startsWith, testNum) => {
  describe(`startsWith ${testNum}`, function() {
